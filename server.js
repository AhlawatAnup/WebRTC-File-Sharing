...
const webSocketServer = http
  .createServer((req, res) => {
    res.writeHead(200);
  })
  .listen(WEBSOCKET_SERVER_PORT, () =>
    console.log("WebSocket server listening on", WEBSOCKET_SERVER_PORT)
  );
...
server.listen(MAIN_SERVER_PORT, "0.0.0.0", () =>
  console.log("Main server listening on", MAIN_SERVER_PORT)
);
